...
export const BarChart = ({ children, ...props }: React.ComponentProps<typeof RechartsBarChart>) => {
...
export const ChartTooltip = ({ children, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
      className="absolute pointer-events-none rounded-md border bg-background p-2 shadow-md"
      {...props}
    >
      {children}
    </div>
